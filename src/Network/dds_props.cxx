    ...
    else if (get_direction() == SG_IO_OUT || get_direction() == SG_IO_BI)
    {
                ...
                prop.mode == FG_DDS_MODE_READ)
        {
            ...
            if (prop.id == FG_DDS_PROP_REQUEST)
            {
                ...
                {
                    const char *path = prop.val._u.String_c1;
                    ...
                    if (it == path_list.end())
                    {
                        ...
                        if (p)
                        {
                            ...
                            try {
                                ...
                                path_list[prop.val._u.String_c1] = prop.id;
